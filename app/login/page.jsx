...
export default function page() {
  return (
    <section className="max-w-[1300px] mx-auto px-5  h-full w-full flex justify-center items-center mb-10 py-5">
      <div className="max-w-[1100px] h-full w-full grid sm:grid-cols-[60%,40%] overflow-hidden rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] relative">
        {/* forlulaire d'inscription */}
        <div className="  bg-white ">
          <form className="w-full h-full space-y-6 p-10 lg:p-24">
