                ...
                <Table>
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.Head>Date de livraison</Table.Head>
                    ...
                    <Table.Body>
                        {
                            orders?.map((item, key) => (
                                <Table.Row key={key}>
                                    ...
                                    <Table.Cell> {dateTimeFormat(item.created_at)}</Table.Cell>
                                    <Table.Cell> {dateTimeFormat(item.date_time_delivery)}</Table.Cell>
                                ...
                                {selectedOrder?.delivrery_driver_id && (
                                    <div className="bg-white rounded-xl shadow-md p-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                                            <div>
                                                <p><strong>Nom
                                                    :</strong> {selectedOrder.delivrery_driver_id.user.full_name}
                                                </p>
                                                <p><strong>Téléphone
                                                    :</strong> {selectedOrder.delivrery_driver_id.user.phone}</p>
                                                <p><strong>Email
                                                    :</strong> {selectedOrder.delivrery_driver_id.user.email}
                                                </p>
                                            </div>
                                            <div>
                                                <p><strong>Adresse
                                                ...
                                                <p><strong>Carte ID
                                                    :</strong> {selectedOrder?.delivrery_driver_id?.id_card}
                                                </p>
                                                <p><strong>Naissance
