          ...
          <div className="space-y-6">
            ...
            {selectedOrder.delivrery_driver_id && (
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                  <div>
                    <p><strong>Nom :</strong> {selectedOrder.delivrery_driver_id.user.full_name}</p>
                    <p><strong>Téléphone :</strong> {selectedOrder.delivrery_driver_id.user.phone}</p>
                    <p><strong>Email :</strong> {selectedOrder.delivrery_driver_id.user.email}</p>
                  </div>
                  <div>
                    <p><strong>Adresse :</strong> {selectedOrder.delivrery_driver_id.user.principal_adresse}</p>
                    <p><strong>Carte ID :</strong> {selectedOrder.delivrery_driver_id.id_card}</p>
                    <p><strong>Naissance :</strong> {new Date(selectedOrder.delivrery_driver_id.birth_date).toLocaleDateString("fr-FR")}</p>
                  </div>
                </div>
              </div>
            )}
