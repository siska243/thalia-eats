...
export default function Information() {
  ...
  return (
    ...
    <div className="p-4 lg:p-10" >
      {
        user && user.user ? (
          <div data-aos="fade-up" className="flex flex-col gap-5 md:flex-row md:gap-10">
        ...
        ) : (<p data-aos="fade-up" className="text-gray-500">Veuillez vous connecter pour voir ces informations.</p>)
      }
    </div >
  );
}
