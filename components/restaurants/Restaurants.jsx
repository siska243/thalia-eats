  ...
  return (
    <section className=" max-w-[1300px] mx-auto px-3 md:px-5 py-5 md:py-10">
      <div className="w-full bg-white rounded-xl">
        <p data-aos="fade-up" className="text-primaryColor text-2xl mb-5 font-semibold">Tous nos restaurants</p>
        <div data-aos="fade-up" className="grid sm:grid-cols-2 grid-cols-1 md:grid-cols-3 gap-5">
