...
export default function CardAll({ imageSrc, title, other, content }) {
  return (
    <div className="relative w-full overflow-hidden rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex py-6 px-6 md:py-8 md:px-8 gap-3">
      <div className="w-1/2 flex-shrink-0">
        ...
        <p className="text-secondaryColor font-bold text-xs sm:text-sm">
          {other}
        </p>
      </div>
