  ...
  const tabs = {
    about: (
      ...
      <div className="text-sm  text-secondaryColor">
          <p className="font-[500] mb-5 leading-8">
      ...
      <p className="font-[500] leading-8">
        ...
        {faq.map((item, index) => (
          <div key={index} className="mb-4 ">
            ...
            <Collapse isOpened={openIndex === index}>
              <div
                className={`transition-all font-[500] text-sm duration-300 mt-2 px-3 py-5 rounded-md ${openIndex === index ? "bg-gray-300" : "bg-white"
                  }`}
              >
                {item.answer}
              </div>
    ...
    partner: (
      <p className="text-sm font-[500] text-secondaryColor leading-8">
